...
const mockProducts = [
  {
    ...
    name: "Fiber Cable",
    description:
      "A range of CPR-certified indoor and outdoor cables, available in both loose tube and tight-buffered constructions.",
    price: 89.99,
    category: "cables",
    sku: "CAT6-BLK-1000",
    images: ["/product.jpg"],
  ...
  },
  {
    ...
    name: "Patch Panels",
    description:
      "A wide selection of patch panels and modular frames designed to fit any installation environment",
    price: 24.99,
  ...
  },
  {
    id: "3",
    name: "Pigtails",
    description: "A comprehensive choice of 100% tested cables/connectivity.",
    price: 4.99,
    category: "adapters",
    sku: "RJ45-ADAP-FF",
    images: ["/product3.png"],
  ...
  {
    id: "4",
    name: "Adaptors & Connectors",
    description:
      "A number of options for the efficient and accurate mating of fibres.",
    price: 159.99,
    category: "fiber",
    sku: "FP-24P-1U",
    images: ["/product4.jpg"],
  ...
  },
  {
    ...
    description:
      "Numerous options for routing, containment and deployment of your DBHL cabling system.",
    price: 8.99,
    category: "patch-cords",
    sku: "CAT6-PC-5FT-BL",
    images: ["/product5.png"],
  ...
  },
  {
    ...
    name: "MTP Solutions",
    description:
      "Offering a modular range of MTP Solutions to provide a highly flexible, high-density patching solution.",
    price: 34.99,
    category: "connectors",
    sku: "MTP-CONN-12F",
    images: ["/product6.png"],
